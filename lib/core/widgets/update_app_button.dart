...
class UpdateAppButton extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return ref.watch(appUpdateStatusProvider).maybeWhen(
          data: (status) => switch (status) {
            UpdateAvailable d => _buildUpdateButton(context, d),
  ...
  Widget _buildUpdateButton(BuildContext context, UpdateAvailable d) {
    return IconButton(
      splashRadius: 12,
      icon: Container(
