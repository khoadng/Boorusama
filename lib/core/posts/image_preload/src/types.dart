...
class PreloadContext {
  ...
  final int itemCount;
  final String? Function(int index) urlBuilder;
  ...
  /// Safely get URL at index, returns null if index is invalid
  String? getUrlAt(int index) => isValidIndex(index) ? urlBuilder(index) : null;
}
...
enum EntryPattern {
  direct, // No movement history - user just opened this image
