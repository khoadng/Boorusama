          ...
          children: [
            MobilePostGridConfigTile(
              ...
              onTap: () {
                ...
                showMaterialModalBottomSheet(
                  context: context,
                  settings: RouteSettings(name: 'page_mode_select'),
            ...
            MobilePostGridConfigTile(
              ...
              onTap: () {
                ...
                showMaterialModalBottomSheet(
                  context: context,
                  settings: RouteSettings(name: 'grid_size_select'),
                  builder: (_) => OptionActionSheet(
            ...
            MobilePostGridConfigTile(
              ...
              onTap: () {
                ...
                showMaterialModalBottomSheet(
                  context: context,
                  settings: RouteSettings(name: 'image_list_select'),
                  builder: (_) => OptionActionSheet(
            ...
            MobilePostGridConfigTile(
              ...
              onTap: () {
                ...
                showMaterialModalBottomSheet(
                  context: context,
                  settings: RouteSettings(name: 'image_quality_select'),
                  builder: (_) => OptionActionSheet(
      ...
      if (postStatsPageBuilder != null && postController.items.isNotEmpty) ...[
        ...
        ListTile(
          ...
          onTap: () {
            ...
            showMaterialModalBottomSheet(
              context: context,
              settings: RouteSettings(name: 'post_statistics'),
