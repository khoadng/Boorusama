...
import '../utils/media_viewport_disposition.dart';
...
class _PostDetailsItemState<T extends Post>
  ...
  Widget build(BuildContext context) {
    ...
    final viewportSize = Size(
      mediaSize.width,
      rawViewportHeight > 0 ? rawViewportHeight : 0.0,
    );

    final disposition = swipeMode.isWebtoon
        ? MediaViewportDisposition.fromViewport(
    ...
    Widget buildPostMedia() {
      return ValueListenableBuilder(
        ...
        builder: (_, isInitPage, _) {
          return ValueListenableBuilder(
            valueListenable: widget.detailsController.currentSettledPage,
        ...
        child: useTallScroller
            ...
            : InteractiveViewerExtended(
                ...
                onTransformationChanged:
                    pageViewController.onTransformationChanged,
                onTap: onItemTap,
                onDoubleTap: switch ((
