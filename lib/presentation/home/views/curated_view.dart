...
class _CuratedViewState extends State<CuratedView>
  ...
  void initState() {
    ...
    _currentPage = 1;
    context.read<PostCuratedBloc>().add(PostCuratedEvent.requested(
      ...
      child: Scaffold(
        ...
        body: Builder(
          ...
          builder: (BuildContext context) {
            return BlocListener<PostCuratedBloc, PostCuratedState>(
              ...
              child:
                  // state is AdditionalPostCuratedFetched)
                  SmartRefresher(
                controller: _refreshController,
                enablePullDown: true,
                header: const WaterDropMaterialHeader(),
                onRefresh: () => BlocProvider.of<PostCuratedBloc>(context)
                    .add(PostCuratedEvent.requested(
                  date: DateTime.now(),
                  scale: TimeScale.day,
                  page: 1,
                )),
                child: CustomScrollView(
                  slivers: <Widget>[
                                  ...
                                  Padding(
                                    ...
                                    child: DropdownButton<TimeScale>(
                                      ...
                                      onChanged: (value) {
                                        ...
                                        context.read<PostCuratedBloc>().add(
                                            PostCuratedEvent.requested(
                                                date: _currentSelectedDate,
                                                scale:
                    ...
                    BlocBuilder<PostCuratedBloc, PostCuratedState>(
