...
class E621InfinitePostList extends ConsumerStatefulWidget {
  const E621InfinitePostList({
    super.key,
    this.onLoadMore,
    this.onRefresh,
  ...
  final Widget Function(E621Post post, void Function() next)?
      contextMenuBuilder;

  final PostGridController<E621Post> controller;
  ...
  final Widget Function(
    List<E621Post> selectedPosts,
    void Function() endMultiSelect,
  )? multiSelectActions;

  @override
  ConsumerState<E621InfinitePostList> createState() =>
      _MoebooruInfinitePostListState();
}

class _MoebooruInfinitePostListState
    extends ConsumerState<E621InfinitePostList> {
  late final AutoScrollController _autoScrollController;
  final _multiSelectController = MultiSelectController<E621Post>();
