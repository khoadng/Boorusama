...
class RootBundleAssetLoader extends el.AssetLoader {
  const RootBundleAssetLoader({required this.supportedLocales});
...
Future<void> ensureI18nInitialized() async {
  el.EasyLocalization.logger = EasyLogger(enableBuildModes: []);
...
class BooruLocalization extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return el.EasyLocalization(
      ...
      assetLoader: RootBundleAssetLoader(supportedLocales: supportedLocales),
      child: child,
    );
  }
}
