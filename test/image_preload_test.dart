...
// Project imports:
import 'package:boorusama/core/posts/image_preload/types.dart';

void main() {
  group('ImagePreloadManager Widget Tests', () {
    testWidgets(
      ...
      (tester) async {
        ...
        final stateSnapshots = <ImagePreloadManagerState>[];
        ...
        String? urlBuilder(int index) {
          if (index < 0 || index >= 100) return null;
          return 'https://gallery.test/images/$index/standard.jpg';
        }
        ...
        expect(
          ...
          isTrue,
          reason: 'Should preload images within bounds',
        );
